...
\addplot[name path = curve, color=blue, thick, samples=50]{(x-3)*(x+2)*x};
\addplot[name path = axis, draw=none] {0};
\addplot[gray!40] fill between[of=curve and axis, soft clip = {domain = -5:-2}];
\addplot[gray!40] fill between[of=curve and axis, soft clip = {domain = 0:3}];
\end{axis}
\end{tikzpicture}
...
\addplot[name path=curve, color=blue, thick, samples=50, domain=-2:2]{1-1/x};
\addplot[gray, dashed] coordinates {(1/3,-3) (1/3,3)};
\addplot[name path=axis, draw=none]{0};
\addplot[gray!40] fill between[of = curve and axis, soft clip = {domain = 1/3:1}];
